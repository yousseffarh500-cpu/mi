...
<body>
    ...
    <div class="card" id="mainContent" style="display: none;">
        ...
        <!-- رسالة التهنئة - مطولة وكلمات رمضانية -->
        <div class="greeting">
            <p>❤️ إلى ميرا الحبيبة ❤️</p>
            <p>✨ كل سنة وأنتِ طيبة ✨</p>
            <p>🌙 رمضانكِ مبارك وسعيد 🌙</p>
            <p>🕌 تقبل الله صيامك وقيامك 🕌</p>
            <p>💫 كل رمضان وأنتِ بخير 💫</p>
            <p>⭐ من يوسف ⭐</p>
        </div>
        ...
        <!-- كلمات تانية -->
        <div style="font-size: 1.3rem; margin: 20px 0; color: #fff5d6;">
            ♥️ أسأل الله لكِ راحة تملأ نفسك، وسعادة تلامس قلبك ♥️
        </div>

        <!-- تذييل -->
        <div class="footer">
            <span class="signature">رمضان 2025 - مبارك عليكم الشهر</span>
        </div>
    </div>
    ...
    <script>
        ...
        // تشغيل الأغنية عند أي ضغطة بعد الدخول لو لسه مش شغالة
